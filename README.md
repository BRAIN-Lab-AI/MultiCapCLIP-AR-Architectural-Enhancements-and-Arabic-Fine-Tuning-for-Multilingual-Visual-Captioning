...
- **Report:** [Project Report](/[https://github.com/BRAIN-Lab-AI/MultiCapCLIP-AR-Architectural-Enhancements-and-Arabic-Fine-Tuning-for-Multilingual-Visual-Captioning/blob/main/MultiCapCLIP_SAB(paper).pdf))
...
- [https://github.com/yangbang18/MultiCapCLIP/tree/master]

### Reference Dataset
- Training Data [MS COCO Dataset](https://cocodataset.org/#home)
- Testing Data  [flickr30k Dataset](http://shannon.cs.illinois.edu/DenotationGraph/data/index.html)

### Dataset Setup
follow the referance GitHub repo in the data structure files 
